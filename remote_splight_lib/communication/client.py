...
from splight_abstract.communication import (
    ...
    CommunicationContext as AbstractCommunicationContext,
    ClientNotReady,
)
from splight_models.notification import NotificationContext
...
class CommunicationContext(AbstractCommunicationContext):
    _model = NotificationContext
...
class CommunicationClient(AbstractCommunicationClient):
    ...
    def _load_context(self):
        self._context = CommunicationContext.build()
    ...
    def _load_client(self):
        ...
        self._client = pysher.Pusher(
            ...
            user_data=self._context.user_data.dict()
        )
