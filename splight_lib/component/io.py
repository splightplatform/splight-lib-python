...
class AbstractIOComponent(AbstractComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.execution_client.start(Task(target=self.refresh_config_forever, period=60))
...
class AbstractClientComponent(AbstractIOComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.execution_client.start(Task(target=self.sync_mappings_to_device, period=10))
...
class AbstractServerComponent(AbstractIOComponent):
    ...
    def __init__(self,
        ...
        self.execution_client.start(Task(target=self.sync_from_datalake, period=10))
