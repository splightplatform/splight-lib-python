...
from splight_lib.mapping import ClientMapping
...
class TestMapping(TestCase):
    ...
    def test_client_mapping_get_default(self):
        scada1 = Asset.objects.create()
        self.assertEqual(scada1.get("q", "10"), "10")

    def test_client_mapping_get_error(self):
        scada1 = Asset.objects.create()
        p = Attribute.objects.create(name="p")
        c = ClientMapping.objects.create(asset=scada1, attribute=p)
    ...
    def test_set_client_mapping(self):
        scada1 = Asset.objects.create()
        p = Attribute.objects.create(name="p")
