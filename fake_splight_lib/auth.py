...
class FakeCredentials:
    def save(self, instance: Dict, resource_id: Optional[str] = None) -> Dict:
        return self._list()[0]
    ...
    def retrieve(self, instance_id: Optional[str] = None) -> Dict:
        return self._list()[0]

    def count(self, *args, **kwagrs) -> int:
        return 40
    ...
    def _list(self):
        return {
            ...
            "metadata": {
                ...
                "manager_email": "fake.manager@splight-ai.com",
            },
        }
        ...
        return [
            {
                ...
                "invitee": {"email": "matias.silva+1234@splight-ae.com"},
                "app_metadata": {},
                "user_metadata": {},
